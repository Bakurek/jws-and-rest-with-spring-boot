/*
 * package com.pjankows.rest.webservices.restfulwebservices;
 * 
 ...
 * "Patryk Jankowski", "www.cern.ch", "pjankows@cern.ch"); public static final
 * ApiInfo DEFAULT_API_INFO = new ApiInfo("API Title", "API Description", "1.0",
